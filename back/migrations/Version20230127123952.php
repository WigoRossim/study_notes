 ...
 */
final class Version20230127123952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Note ADD CONSTRAINT FK_6F8F552AA76ED395 FOREIGN KEY (user_id) REFERENCES Note (id)');
    }
